...
geometry: margin=1in
biblio-style: apsr
bibliography: ["r-references.bib", "r-packages.bib"]
graphics: yes
header-includes:
  - \usepackage{amsmath}
  - \usepackage{siunitx}
...
```{r vsothersmetrics, fig.cap="Accuracy and F1 score of the classifications made by our models compared with those made by widely used software", echo=FALSE, message=FALSE}
